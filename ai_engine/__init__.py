...
from .model_registry import (
    ModelProvider, ModelInfo, MODEL_CATALOG, DYNAMIC_MODEL_CATALOG,
    get_model_info, list_all_models, get_models_by_provider,
    get_available_providers, register_dynamic_model, clear_dynamic_models,
    fetch_all_provider_models, normalize_provider
)
...
def get_advanced_ai_engine(
    ...
    return AdvancedAIEngine(model_id=model_id, provider=provider, custom_route=custom_route)
